...
## Configuration #######################################################################################################
local_name = 'ComfoConnect Gateway MQTT'			# Name of the service
...
device_ip = "192.168.1.xx"					# Look in your router administration and get the ip of the comfoconnect device and set it as static lease
device_uuid = bytes.fromhex('00000000000000000000000000000000') # Get this from using discovery first by running the script with flag: -d <ip-address> and then configure it here
pin = 5505 							# Set PIN of vent unit !

mqtt_broker = "192.168.1.xx"		# Set your MQTT broker here
mqtt_user = ""						# Set the MQTT user login
mqtt_passw = ""						# Set the MQTT user password
...
client.subscribe("Zehnder/ComfoAirQ350/ExecuteFunction",qos=1)
